...
pub struct WhatsAppConfig {
    ...
    /// Optional prefix that messages must start with to be processed (e.g. "@zeroclaw")
    #[serde(default)]
    pub bot_identifier: Option<String>,
    /// Optional prefix prepended to all responses sent by the bot (e.g. "ZC: ")
    #[serde(default)]
